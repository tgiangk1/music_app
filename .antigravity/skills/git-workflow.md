...
PR body sử dụng template tại `.github/pull_request_template.md`, bao gồm:

| Section | Mục đích |
|---------|----------|
| **Summary** | Mô tả ngắn gọn PR làm gì |
| **Type** | Chọn 1 trong: feature / fix / refactor / chore / docs |
| **Scope** | Scope chính (player, auth, ui, api, ...) |
| **Changes** | Liệt kê thay đổi, nhóm theo Backend / Frontend |
| **Removed** | Files/features đã xóa (nếu có) |
| **Testing** | Checklist đã test những gì |
| **Screenshots** | Attach nếu có UI changes |
| **Related** | Link issues/PRs liên quan |
| **Notes** | Breaking changes hoặc lưu ý review |

> Khi tạo PR qua GitHub API, **luôn** điền đầy đủ body theo template trên.
> Xóa các section không liên quan thay vì để trống.
